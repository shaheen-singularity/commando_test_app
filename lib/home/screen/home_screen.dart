                        ...
                        Card(
                          child: ListTile(
                            ...
                            trailing: ToggleSwitch(
                              ...
                              minHeight: 35.0,
                              initialLabelIndex:
                                  controller.fireSensorUpdateStatus.value == true ? 1 : 0,
                              cornerRadius: 8.0,
                              ...
                              labels: const ["Off", "On"],
                              fontSize: 8,
                              customTextStyles: const [TextStyle(fontWeight: FontWeight.bold,fontSize: 16)],
                              ...
                              animate: true,
                              changeOnTap:
                                  controller.fireSensorUpdateStatus.value == true ? true : false,
                        ...
                        Card(
                          child: ListTile(
                            ...
                            trailing: ToggleSwitch(
                              ...
                              minHeight: 35.0,
                              initialLabelIndex:
                                  controller.smokeSensorUpdateStatus.value == true ? 1 : 0,
                              cornerRadius: 8.0,
                              activeFgColor: Colors.white,
                              inactiveBgColor: Colors.grey,
                              inactiveFgColor: Colors.white,
                              ...
                              animate: true,
                              changeOnTap:
                                  controller.smokeSensorUpdateStatus.value == true ? true : false,
                              curve: Curves.easeOut,
                              onToggle: (index) {
                                if (controller.regNumberController.text.isNum &&
                                    controller.regNumberController.text.isNotEmpty) {
                        ...
                        Card(
                          child: ListTile(
                            ...
                            trailing: ToggleSwitch(
                              ...
                              minHeight: 35.0,
                              initialLabelIndex:
                                  controller.shutterSensorUpdateStatus.value == true ? 1 : 0,
                              cornerRadius: 8.0,
                              activeFgColor: Colors.white,
                              inactiveBgColor: Colors.grey,
                              inactiveFgColor: Colors.white,
                              ...
                              curve: Curves.easeOut,
                              changeOnTap:
                                  controller.shutterSensorUpdateStatus.value == true ? true : false,
                              onToggle: (index) {
                                if (controller.regNumberController.text.isNum &&
                                    controller.regNumberController.text.isNotEmpty) {
                                  controller.value(index);
                        ...
                        Card(
                          child: ListTile(
                              ...
                              trailing: ToggleSwitch(
                                ...
                                minHeight: 35.0,
                                initialLabelIndex:
                                    controller.motionSensorUpdateStatus.value == true ? 1 : 0,
                                cornerRadius: 8.0,
                                activeFgColor: Colors.white,
                                inactiveBgColor: Colors.grey,
                                inactiveFgColor: Colors.white,
                                ...
                                animate: true,
                                curve: Curves.easeOut,
                                changeOnTap: controller.motionSensorUpdateStatus.value == true
                                    ? true
                                    : false,
                                onToggle: (index) {
                                  if (controller.regNumberController.text.isNum &&
